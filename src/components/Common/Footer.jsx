    ...
    <div >
      ...
      <div className="container mx-auto text-left grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 px-4 lg:px-0 lg:justify-items-center">
        ...
        <div className=" md:text-left lg:text-left lg:col-span-2">
          ...
          <p className="text-gray-500 mb-4 lg:max-w-[20vw]">
          ...
          <form className="flex max-w-md ">
            <input
              ...
              className="p-3 flex-1 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all text-sm"
              required
            />
            <button
              type="submit"
              className="bg-black text-white px-6 py-3 rounded-r-md hover:bg-gray-800 transition text-sm cursor-pointer"
            >
              Subscribe
            </button>
          </form>
        ...
        <div className=" lg:text-left md:text-left">
          ...
          <p className="text-gray-500 pb-2">Call Us</p>
          <p className="flex items-center lg:justify-center  text-gray-700">
