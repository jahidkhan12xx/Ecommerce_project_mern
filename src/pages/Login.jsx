        ...
        <div className=" w-1/2 h-full bg-[#f5f5f5]  flex flex-col p-20 justify-between items-center">
         <Reveal> <h1 className="text-xl text-text-primary font-semibold">Interactive Brand</h1></Reveal>
          ...
          <div className=" w-full flex flex-col max-w-[555px]">
            ...
            <Reveal><h3 className=" text-2xl font-semibold mb-4">Login</h3></Reveal>
            <Reveal><p className="text-sm mb-2">Welcome Back! Please enter your details</p></Reveal>
            ...
            <div className="flex w-full flex-col my-4">
              ...
              <button onClick={handleLogin} type="submit" className="w-full cursor-pointer bg-text-primary text-main-bg rounded-md p-4 flex items-center justify-center">
           ...
           <Reveal> <FaGoogle /></Reveal>
            <Reveal><span>Sign In With Google</span></Reveal>
          ...
          <div className="w-full flex items-center justify-center">
           <Reveal> <p className=" text-sm font-normal text-text-primary">Don't have a account? <span className="font-semibold underline underline-offset-2 cursor-pointer"><Link to="/register">Sign up for free</Link></span> </p></Reveal>
